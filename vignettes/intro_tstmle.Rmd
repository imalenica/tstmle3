...
- Relavent inference for the TMLE estimate, including the standard deviation, confidence interval, and the estimated influence function. 
...
#Obtain estimates:
res<-tstmleSI(sim_ts_s1_n50, Cy=6, Ca=5, V=3, Q_library, g_library)
